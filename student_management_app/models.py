...
def create_user_profile(sender, instance, created, **kwargs):
    if created:
        ...
        if instance.user_type == 3:
            Student.objects.create(admin=instance, course_id=Courses.objects.get(id=1), session_start_year="2021-01-01",
                                   session_end_year="2022-01-01", address="", profile_pic="", gender="")
