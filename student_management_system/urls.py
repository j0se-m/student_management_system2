...
urlpatterns = [
                  ...
                  path('', views.homepage, name="homeyoo"),
                  path('get_user_details', views.GetUserDetails),
                  path('logout_user', views.logout_user, name="logout"),
                  path('doLogin', views.doLogin, name="do_login"),
                  path('admin_home', HodViews.admin_home, name="homepag"),
                  ...
                  path('delete_staff/<int:staff_id>', HodViews.delete_staff),
                  path('manage_student', HodViews.manage_student, name="manage_student"),
                  path('delete_student/<int:student_id>', HodViews.delete_student),
                  path('manage_course', HodViews.manage_course, name="manage_course"),
                  path('delete_course/<int:course_id>', HodViews.delete_course),
                  ...
                  # path('register/',HodViews.register, name='register'),
